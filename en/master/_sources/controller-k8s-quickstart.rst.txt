...
If you wish to install the controller on an existing Kubernetes cluster, follow `these instructions <https://www.netris.io/docs/en/latest/controller-k8s-installation.html>`_ instead of this Quickstart.
...
3. Navigate in the UI to  Net→IPAM and add a new subnet that contains the desired management IP addresses you wish to use for your SoftGates and switches.
   ...
   Detailed configuration documentation is available here: `Netris IPAM <https://www.netris.io/docs/en/latest/ipam.html>`_.
