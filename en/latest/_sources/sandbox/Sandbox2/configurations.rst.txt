...
===================================
To access the V-Net service example, first log into the Netris Controller by visiting `https://sandbox2.netris.io <https://sandbox2.netris.io>`_ and navigating to **Services → V-Net**, where you will find a pre-configured V-Net service named "**vnet-example**" available as an example.
...
3. Select "**SoftGate1(45.38.161.32)**" from the **Hardware** drop-down menu.
