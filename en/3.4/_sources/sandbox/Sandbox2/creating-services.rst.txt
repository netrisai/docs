...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris Controller by visiting `https://sandbox2.netris.io <https://sandbox2.netris.io>`_ and navigate to **Net → E-BGP**.
...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris Controller by visiting `https://sandbox2.netris.io <https://sandbox2.netris.io>`_ and navigate to **Net → NAT**.
...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris Controller by visiting `https://sandbox2.netris.io <https://sandbox2.netris.io>`_ and navigate to **Net → Sites**.
