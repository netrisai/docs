...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris Controller by visiting `https://sandbox11.netris.io <https://sandbox11.netris.io>`_ and navigate to **Net → E-BGP**.
  ...
  7. For the **VLAN ID** field, uncheck the **Untag** check-box and type in ``1112``.
...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris Controller by visiting `https://sandbox11.netris.io <https://sandbox11.netris.io>`_ and navigate to **Net → NAT**.
...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris Controller by visiting `https://sandbox11.netris.io <https://sandbox11.netris.io>`_ and navigate to **Net → Sites**.
