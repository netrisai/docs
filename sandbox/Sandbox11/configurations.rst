...
===================================
After logging into the Netris Controller by visiting `https://sandbox11.netris.ai <https://sandbox11.netris.ai>`_ and navigating to **Services → V-Net**, you will find a V-Net service named "**vnet-example**" already configured for you as an example. 
...
* In a terminal window:
  ...
  1. SSH to srv04-nyc: ``ssh demo@50.117.27.82 -p 30064``.
