...
If you see the same as shown in the previous screenshot, it means you didn’t create "vnet-customer" VNet as stated in the :ref:`"Learn by Creating Services"<s13-v-net>` manual. If so, let’s create it from Kubernetes using the VNet custom resource.
...
BTW, if you already created "vnet-customer" VNet as stated in the :ref:`"Learn by Creating Services"<s13-v-net>`, you may import that to k8s, by adding ``resource.k8s.netris.ai/import: "true"`` annotation in VNet manifest, the manifest should look like this:
...
.. code-block:: shell-session
  ...
  isp2-customer   enabled               Link Up      65007         45.38.161.166/30   45.38.161.165/30   15s
...
.. code-block:: shell-session
  ...
  NAME            STATE     BGP STATE                                       PORT STATE   NEIGHBOR AS   LOCAL ADDRESS      REMOTE ADDRESS     AGE
  isp2-customer   enabled   bgp: Established; prefix: 160; time: 00:01:27   Link Up      65007         45.38.161.166/30   45.38.161.165/30   2m3s
...
.. code-block:: shell-session
  ...
  NAME                                 STATE     BGP STATE                                      PORT STATE   NEIGHBOR AS   LOCAL ADDRESS      REMOTE ADDRESS      AGE
  isp2-customer                        enabled   bgp: Established; prefix: 160; time: 00:06:18  Link Up      65007         45.38.161.166/30   45.38.161.165/30    7m59s
...
.. code-block:: shell-session
  ...
  NAME                                 STATE     BGP STATE                                       PORT STATE   NEIGHBOR AS   LOCAL ADDRESS      REMOTE ADDRESS      AGE
  isp2-customer                        enabled   bgp: Established; prefix: 160; time: 00:07:48   Link Up      65007         45.38.161.166/30   45.38.161.165/30    8m41s
