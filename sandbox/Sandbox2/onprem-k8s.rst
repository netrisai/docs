...
.. image:: /images/sandbox2-l4lb-kubeapi.png
    :align: center
...
.. code-block:: shell-session
    ...
    Kubernetes master is running at https://api.k8s-sandbox2.netris.io:6443
...
.. image:: /images/sandbox2-podinfo-prov.png
    :align: center
...
.. image:: /images/sandbox2-podinfo-ready.png
    :align: center
...
.. image:: /images/sandbox2-l4lbs.png
    :align: center

V-Net Custom Resource
--------------------

If one of the backend health-checks is marked as unhealthy like in the screenshot above, it means you didn’t create "vnet-customer" V-Net as described in the :ref:`"Learn by Creating Services"<s2-v-net>` manual. If that's the case, let's create it from Kubernetes using the V-Net custom resource.
...
BTW, if you already created "vnet-customer" V-Net as described in the :ref:`"Learn by Creating Services"<s2-v-net>`, you may import that to k8s, by adding ``resource.k8s.netris.ai/import: "true"`` annotation in V-Net manifest, the manifest should look like this:
