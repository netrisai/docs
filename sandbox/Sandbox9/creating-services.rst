...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris GUI by visiting `https://sandbox9.netris.ai <https://sandbox9.netris.ai>` and navigate to **Services > V-Net**.
...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris GUI by visiting `https://sandbox9.netris.ai <https://sandbox9.netris.ai>` and navigate to **Net > E-BGP**.
...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris GUI by visiting `https://sandbox9.netris.ai <https://sandbox9.netris.ai>` and navigate to **Net > NAT**.
...
* In a web browser: (*\*Fields not specified should remain unchanged and retain default values*)
  ...
  1. Log into the Netris GUI by visiting `https://sandbox9.netris.ai <https://sandbox9.netris.ai>` and navigate to **Net > Sites**.
