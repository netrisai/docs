...
.. image:: /images/sandbox1-l4lb-kubeapi.png
    :align: center
...
.. image:: /images/sandbox1-podinfo-prov.png
    :align: center
...
.. image:: /images/sandbox1-podinfo-ready.png
    :align: center
...
.. image:: /images/sandbox1-l4lbs.png
    :align: center

V-Net Custom Resource
--------------------

If one of the backend health-checks is marked as unhealthy like in the screenshot above, it means you didn’t create "vnet-customer" V-Net as described in the :ref:`"Learn by Creating Services"<s1-v-net>` manual. If that's the case, let's create it from Kubernetes using the V-Net custom resource.
...
BTW, if you already created "vnet-customer" V-Net as described in the :ref:`"Learn by Creating Services"<s1-v-net>`, you may import that to k8s, by adding ``resource.k8s.netris.ai/import: "true"`` annotation in V-Net manifest, the manifest should look like this:
...
Let’s create a new BGP peer, that is listed in the :ref:`"Learn by Creating Services"<s1-e-bgp>`.
