...
===================================
Once you log into the Netris GUI by visiting **https://demo68.netris.ai** and navigating to **Services > V-Net**, you will find a V-Net service named "**V-Net Example**" already configured for you as an example. You can examine the particular service settings by selecting **Edit** from the **Actions** menu indicated by three vertical dots (⋮) on the right side of the "**V-Net Example**" service.
...
2. Select the **ssw01-nyc(10.254.42.1)** switch from the **Select switch** drop-down menu.
...
.. code-block:: shell-session
  ...
  64 bytes from 192.168.41.64: icmp_seq=1 ttl=64 time=33.4 ms
  64 bytes from 192.168.41.64: icmp_seq=2 ttl=64 time=27.1 ms
  64 bytes from 192.168.41.64: icmp_seq=3 ttl=64 time=0.702 ms
  64 bytes from 192.168.41.64: icmp_seq=4 ttl=64 time=1.37 ms
  64 bytes from 192.168.41.64: icmp_seq=5 ttl=64 time=0.609 ms
